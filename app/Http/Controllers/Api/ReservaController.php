...
class ReservaController extends Controller
{
    ...
    public function index(\Illuminate\Http\Request $request)
    {
        ...
        if ($user?->administrador) {
            $query = \App\Models\Reserva::with(['cliente.usuario', 'profesional.usuario', 'servicio', 'pago', 'horario', 'paqueteComprado.paqueteServicio.servicio.ubicacion']);
            if ($idProfesional) {
            ...
            $reservas = \App\Models\Reserva::with(['cliente.usuario', 'profesional.usuario', 'servicio', 'pago', 'horario', 'paqueteComprado.paqueteServicio.servicio.ubicacion'])
